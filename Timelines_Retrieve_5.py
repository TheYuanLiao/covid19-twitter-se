...
ACCESS_TOKEN = 'lPr4E4cEoADBWo1znUsUsx5qu' # Consumer API key
ACCESS_SECRET = 'yMwQg13HQq0e7zNJx0AFfoXAEktjOobbuuVNqbATQzNT35bAxs' # Consumer secret key
CONSUMER_KEY = '1110852498233978880-hJSllAcReyDlpt13fAsv5t3atEXPwH' # Access token
CONSUMER_SECRET = 'K4gGhRlb4PR9Zler3XsivD1fCOgMTBxtwTiRW3rfAjTnf' # Access token secret
